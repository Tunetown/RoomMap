...
The program is fully implemented in Java using Swing, the minimum version requirement is Java 1.8. A complex installation is generally not necessary:

### Mac OS
For Mac OS X users, there is a DMG package ready for download: https://github.com/Tunetown/RoomMap/tree/master/release/macosx/bundles
...
4. Export the measurements from REW as text files. This is done in the menu:
TODO
REW then creates one file per measurement, which contains the SPL for given frequencies. The file name will contain the coordinates as entered under point 3.
5. Launch the RoomMap program, browse to the folder where you stored the REW export files, and select all of them. Then hit "Open". The program will soon show you a first SPL map of your room :)
TODO
